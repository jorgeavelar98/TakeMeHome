...
class InsaneModeScene: SKScene, SKPhysicsContactDelegate {
    ...
    func startMakingAsteroids() {
        ...
        let asteroidDelay = SKAction.waitForDuration(0.20)
    ...
    func scoreLabelCount() {
        ...
        self.runAction(SKAction.repeatActionForever(SKAction.sequence([delay,incrementScore])), withKey: "scoreCount2")
    }
    ...
    func playerScoreUpdate() {
        let highScore2 = NSUserDefaults().integerForKey("highscore2")
        if score > highScore2 {
            NSUserDefaults().setInteger(score, forKey: "highscore2")
        }
        
        highScoreLabel.text = "High Score: " + NSUserDefaults().integerForKey("highscore2").description
    }
    ...
    func gameOver() {
        ...
        self.removeActionForKey("scoreCount2")
